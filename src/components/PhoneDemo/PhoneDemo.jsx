      ...
      <div className={styles.phoneScreen}>
        ...
        {!scanOnly && (
          <div className={`${styles.screen} ${activeTab === "home" ? styles.active : ""}`}>
            <div className={styles.hello}>Xin chào, Minh Anh 👋</div>
            ...
            <div className={styles.sensors}>
              <div className={styles.sensor}><small>Nhiệt độ</small><b><span className={`${styles.dot} ${styles.blueDot}`} />Ổn định</b></div>
              <div className={styles.sensor}><small>Độ ẩm</small><b><span className={`${styles.dot} ${styles.yellowDot}`} />Cần chú ý</b></div>
            </div>
        ...
        <div className={styles.tabbar}>
          ...
          <button type="button" className={`${styles.tab} ${activeTab === "scan" ? styles.activeTab : ""}`} onClick={scanOnly ? undefined : () => goTo("scan")}><b>⌁</b>Quét</button>
          <button type="button" className={`${styles.tab} ${activeTab === "reminders" ? styles.activeTab : ""}`} onClick={scanOnly ? undefined : () => goTo("reminders")}><b>◷</b>Lịch nhắc</button>
          <button type="button" className={`${styles.tab} ${activeTab === "drug" ? styles.activeTab : ""}`} onClick={scanOnly ? undefined : () => goTo("drug")}><b>✚</b>Thuốc</button>
